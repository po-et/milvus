...
func TestCatalog_ListRLSPrincipalsLimits(t *testing.T) {
	...
	totalBytes := rlsutil.PrincipalTagsSize(principals[0].PrincipalName, principals[0].Tags) +
		rlsutil.PrincipalTagsSize(principals[1].PrincipalName, principals[1].Tags)
